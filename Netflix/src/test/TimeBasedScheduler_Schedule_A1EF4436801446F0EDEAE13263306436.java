...
public class TimeBasedScheduler_Schedule_A1EF4436801446F0EDEAE13263306436
		extends com.ibm.rational.test.lt.kernel.action.impl.Schedule {

	public TimeBasedScheduler_Schedule_A1EF4436801446F0EDEAE13263306436(IContainer parent, String name) {
		super(parent, name, "A1EF4436801446F0EDEAE13263306436");
		super.actualScheduleName = "TimeBasedScheduler";
		setThinkMax(10000);
	...
	private PacedLoop pacedLoop_1(IContainer parent) {
		PacedLoop pacedLoop = new PacedLoop(parent, "Loop1", "A1EF4434ADB5DDA0EDEAE13263306436", 3, 60000, 0, 0, 1,
				true, true, 10, 1000, IPacedLoop.CONSTANT, false, null) {
